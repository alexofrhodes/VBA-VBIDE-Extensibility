...
'--------------------------------------------------
' Fun AvailableFormOrFrameColumn  As Long           :
' Fun AvailableFormOrFrameRow     As Long           :
' Fun CreateOrSetFrame            As MSForms.Frame  :
' Fun TextOfControl               As Variant        :
' Sub AddFormControls                               :
' Sub AddMultipleControls                           :
' Sub flashControl                                  :
'--------------------------------------------------
