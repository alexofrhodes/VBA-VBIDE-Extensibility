...
'--------------------------------------------------
' Fun HideTitleBarAndBorder    As Variant  :
' Fun MakeUserformTransparent  As Variant  :
' Fun MouseCursor              As Variant  :
' Fun MouseMoveIcon            As Variant  :
' Fun getMonth                 As Variant  :
' Sub moverForm                            :
' Sub removeTudo                           :
'--------------------------------------------------
