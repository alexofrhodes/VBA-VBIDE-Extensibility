...
'--------------------------------------------------
' Fun IniKeyExists      As Boolean  :
' Fun IniReadKey        As Variant  :
' Fun IniReadSection    As Variant  :
' Fun IniSectionExists  As Boolean  :
' Fun IniSectionKeys    As Variant  :
' Fun IniSections       As Variant  :
' Sub IniWrite                      :
' Sub TestINI                       :
' Sub TestReadKey                   :
' Sub TestWriteKey                  :
